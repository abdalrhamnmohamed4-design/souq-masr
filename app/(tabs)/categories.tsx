 ...
 * المصدر الوحيد بقى mock/taxonomy/categories.ts (الـ18+1 تصنيف رئيسي)
 * — الضغط على أي تصنيف بيفتح متصفّح تدريجي (app/category/[id].tsx).
 */
...
import { categoryLabel, getAllDescendantIds, getTopLevel } from '@/mock/taxonomy/categories';
